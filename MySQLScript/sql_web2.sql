...
VALUES
    ...
    (1, 1, 20, 80000, 40000, 1, '2025-02-06 10:00:00'),  -- 'Cho Tôi Xin Một Vé Đi Tuổi Thơ'
    (1, 2, 15, 100000, 50000, 1, '2025-02-06 10:00:00'),  -- 'Tôi Thấy Hoa Vàng Trên Cỏ Xanh'
    (1, 15, 15, 80000, 45000, 1, '2025-02-06 10:00:00'),  -- 'Mắt Biếc'

    -- Đơn nhập hàng 2 (Nhà Xuất Bản Kim Đồng)
    (2, 3, 20, 50000, 30000, 0, NULL),  -- 'Dế Mèn Phiêu Lưu Ký'
    (2, 13, 10, 20000, 15000, 0, NULL),  -- 'Doraemon Tập 1'

    -- Đơn nhập hàng 3 (Nhà Xuất Bản Văn Học)
    (3, 4, 15, 60000, 30000, 1, '2025-02-08 12:00:00'),  -- 'Nhật Ký Trong Tù'
    (3, 5, 10, 70000, 40000, 1, '2025-02-08 12:00:00'),  -- 'Số Đỏ'
    (3, 6, 15, 60000, 35000, 1, '2025-02-08 12:00:00'),  -- 'Truyện Kiều'

    -- Đơn nhập hàng 4 (Nhà Xuất Bản Tổng Hợp TP.HCM)
    (4, 7, 10, 55000, 30000, 0, NULL),  -- 'Bố Con Cá Gai'
    (4, 8, 10, 85000, 45000, 0, NULL),  -- 'Cánh Đồng Bất Tận'

    -- Đơn nhập hàng 5 (Nhà Xuất Bản Giáo Dục)
    (5, 9, 20, 90000, 50000, 1, '2025-02-10 14:00:00'),  -- 'Nỗi Buồn Chiến Tranh'
    (5, 14, 30, 30000, 15000, 1, '2025-02-10 14:00:00'),  -- 'Toán Lớp 10'
    (5, 10, 10, 120000, 60000, 1, '2025-02-10 14:00:00'), -- 'Harry Potter và Hòn Đá Phù Thủy'

    -- Đơn nhập hàng 6 (Nhà Xuất Bản Hội Nhà Văn)
    (6, 11, 15, 70000, 40000, 0, NULL),  -- 'Nhà Giả Kim'
    (6, 12, 10, 60000, 35000, 0, NULL),  -- 'Đắc Nhân Tâm'

    -- Đơn nhập hàng 7 (Nhà Xuất Bản Phụ Nữ)
    (7, 1, 10, 80000, 40000, 1, '2025-02-12 16:00:00'),  -- 'Cho Tôi Xin Một Vé Đi Tuổi Thơ'
    (7, 2, 10, 100000, 50000, 1, '2025-02-12 16:00:00'),  -- 'Tôi Thấy Hoa Vàng Trên Cỏ Xanh'
    (7, 15, 15, 80000, 45000, 1, '2025-02-12 16:00:00'),  -- 'Mắt Biếc'

    -- Đơn nhập hàng 8 (Nhà Xuất Bản Lao Động)
    (8, 3, 20, 50000, 30000, 0, NULL),  -- 'Dế Mèn Phiêu Lưu Ký'
    (8, 13, 15, 20000, 15000, 0, NULL),  -- 'Doraemon Tập 1'
    (8, 14, 10, 30000, 15000, 0, NULL),  -- 'Toán Lớp 10'

    -- Đơn nhập hàng 9 (Nhà Xuất Bản Thanh Niên)
    (9, 4, 5, 60000, 30000, 1, '2025-02-14 18:00:00'),  -- 'Nhật Ký Trong Tù'
    (9, 5, 5, 70000, 40000, 1, '2025-02-14 18:00:00'),  -- 'Số Đỏ'
    (9, 6, 5, 60000, 35000, 1, '2025-02-14 18:00:00'),  -- 'Truyện Kiều'

    -- Đơn nhập hàng 10 (Nhà Xuất Bản Văn Hóa - Văn Nghệ)
    (10, 7, 15, 55000, 30000, 0, NULL),  -- 'Bố Con Cá Gai'
    (10, 8, 20, 85000, 45000, 0, NULL),  -- 'Cánh Đồng Bất Tận'
    (10, 9, 20, 90000, 50000, 0, NULL);  -- 'Nỗi Buồn Chiến Tranh'
